...
import com.project.financedashboard.service.AuthService;
...
public class AuthController {
    ...
    @Operation(summary = "Login",
            description = "Returns a JWT token to use in Authorization header" +
                    "Test credentials:\n" +
                    "            - admin@project.com / admin123 → full access\n" +
                    "            - analyst@project.com / analyst123 → read + dashboard\n" +
                    "            - viewer@project.com / viewer123 → read only")
